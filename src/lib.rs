...
//! by Cambrian Technologies [[GitHub]](https://github.com/cambrian/accumulator).
//!
...
//! (1) an RSA group implementation with the
//! [RSA-2048 modulus](https://en.wikipedia.org/wiki/RSA_numbers#RSA-2048) and (2) a form class
//! group implementation with a fixed discriminant (generated by OpenSSL).
//!
