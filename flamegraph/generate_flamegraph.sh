...
FLAMEGRAPH_FILENAME=$1.flame.svg
./stackcollapse.pl out.stacks | grep closure | ./flamegraph.pl > $FLAMEGRAPH_FILENAME
echo "Done. Your flamegraph is now at flamegraph/"$FLAMEGRAPH_FILENAME
